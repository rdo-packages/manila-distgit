...
%description -n python%{pyver}-tests
%{common_desc}
...
PYTHONPATH=. oslo-config-generator-%{pyver} --config-file=etc/oslo-config-generator-%{pyver}/%{service}.conf
